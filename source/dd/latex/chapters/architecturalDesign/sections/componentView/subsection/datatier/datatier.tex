...
\begin{document}
	...
	\item{Taxi Driver}: this class extends represent the information about the taxi drivers 
	\item{Customer}: this class represent the information about the customers
